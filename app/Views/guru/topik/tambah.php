      ...
      <div class="card w-100">
        <div class="card-body p-4">
          ...
          <div class="table-responsive">
            <form action="<?= base_url('admin/materi/topik/proses_tambah') ?>" method="post">
              <div class="mb-3">
                <label for="nama_topik" class="form-label">Judul Topik</label>
                <input type="text" class="form-control" id="nama_topik" name="nama_topik" aria-describedby="nama_topik">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <div class="card">
                  <div class="card-body p-4 mx-auto">
                    ...
                    <div id="editor"><textarea name="editor" id="editor" cols="30" rows="10"></textarea></div>
              ...
              <input hidden type="text" class="form-control" id="id_materi" name="id_materi" aria-describedby="id_materi" value="<?= $id_materi ?>">
